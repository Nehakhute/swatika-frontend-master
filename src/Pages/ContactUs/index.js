...
function ContactUs(props) {
  ...
  const onSendMessage = () => {
    if (
      ...
      message.error("Please enter valid details...", 2);
      return;
    }
    setLoading(true);
    const payload = {
    ...
    dispatch(
      sendContactUsMessag(
        ...
        () => {
          message.success(
            "Thank you for contact us..our team will contact you with 3 hours.."
          );
          setName("");
          setEmail("");
          setMobileNum("");
        ...
        (e) => {
          message.error(e || "Failed to send message..");
          setLoading(false);
        }
      )
    );
        ...
        <div className="left-box">
          ...
          <div className="single-box">
            ...
            <div className="box-content">
              ...
              <span className="box-content-value">
                Office No.604 Shagun Insignia Sector-19 Plot no.195 Ulwe Navi
                Mumbai India 410206.
              </span>
            </div>
          </div>
